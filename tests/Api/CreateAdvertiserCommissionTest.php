...
class CreateAdvertiserCommissionTest extends TestCase {
    ...
    public function testSendsPostWithAffiliateUserId(): void
    {
        ...
        $this->assertSame(
            '/advertiser/programs/default/commissions.json',
